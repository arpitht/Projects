...
Retype Password:<input type="password" name="repwd" class="bar"><br>
Firstname:<input type="text" name="firstname" class="bar"><br>
Lastname:<input type="text" name="lastname" class="bar"><br>
Gender:<input type="text" name="gender" class="bar"><br>
Date Of Birth:
...
email:<input type="text" name="email" class="bar"><br>
